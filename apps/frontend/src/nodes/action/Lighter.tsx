...
const styles = {
  container: "flex flex-col items-center justify-center px-3 py-2 min-w-[130px] min-h-[50px] bg-white/90 dark:bg-slate-900/90 backdrop-blur-xl border border-slate-200 dark:border-slate-700 shadow-xl dark:shadow-2xl rounded-lg text-slate-800 dark:text-slate-100 font-medium transition-all hover:border-purple-500 hover:shadow-purple-500/20",
  header: "flex items-center gap-1 mb-1.5 text-purple-500 dark:text-purple-400",
  title: "text-[9px] uppercase tracking-wider font-bold",
  row: "flex w-full justify-between items-center bg-slate-100 dark:bg-slate-800/50 rounded px-1.5 py-0.5 mb-1",
  rowLast: "flex w-full justify-between items-center bg-slate-100 dark:bg-slate-800/50 rounded px-1.5 py-0.5",
  label: "text-[9px] text-slate-500 dark:text-slate-400",
  valueLong: "text-[10px] font-bold text-emerald-600 dark:text-emerald-400",
  valueShort: "text-[10px] font-bold text-rose-600 dark:text-rose-400",
  value: "text-[10px] font-bold text-slate-700 dark:text-slate-200",
